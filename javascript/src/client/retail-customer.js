...
class TotvsRetailCustomer extends TotvsBaseClient {
  ...
  async create(customerData = {}) {
    ...
    z.parse.string(customerData.rg, "rg").optional();
  ...
  async remove(customerCode) {
    ...
    return this.doRequest("DELETE", `${this.endpoint}/${customerCode}`);
  }
  ...
  async get(customerCode) {
    ...
    return this.doRequest("GET", `${this.endpoint}/${customerCode}`);
  }
  ...
  async update(customerCode, customerData = {}) {
    ...
    return this.doRequest("POST", `${this.endpoint}`, customerData);
  }
}
